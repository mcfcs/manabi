...
DAILY_BRIEFING_PROMPT = (
    ...
    " due today. Anything further out is not urgent enough to mention. Write"
    " full sentences naming the item — never a bare title on its own. If nothing"
    " qualifies, return an EMPTY STRING: \"\". Do not fill it with an emoticon,"
    " a symbol, a dash, or a placeholder — an empty field is correct and the app"
    " simply omits that paragraph.\n"
    ...
    " headers, no emoji and no emoticons; speak times and numbers naturally."
    " Every field you do fill must be a real sentence. This is not a citable"
    " answer — do not cite sources.\n\n"
    "Produce JSON matching the schema."
)
